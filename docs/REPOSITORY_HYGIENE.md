...
The policy is product-neutral. Add a product by creating `config/products/<product-id>/job.json` and `license.json`, not by cloning a product-specific workflow.

#!/usr/bin/env python3
"""Robust SiroinoSotai_PC fit entrypoint for the military romper.

This wrapper keeps the target-surface implementation in
``siroino_military_sheer_romper_target_fit`` and replaces only selections that
must adapt to the exact imported SiroinoSotai_PC skeleton and body bounds.
"""

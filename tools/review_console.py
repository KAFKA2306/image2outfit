...
STYLE = """
:root{--bg:#f4f7fb;--surface:#fff;--surface-2:#eef3f8;--ink:#111827;--muted:#667085;--line:#d9e1ea;--accent:#1677a8;--accent-soft:#e7f5fb;--danger:#a43b3b;font-family:Inter,'Noto Sans JP',system-ui,sans-serif}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);line-height:1.55}a{color:var(--accent)}button,input,select{font:inherit;min-height:44px}button{cursor:pointer}header,main,footer{width:min(1240px,calc(100% - 24px));margin:auto}header{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:16px 0}nav{display:flex;gap:12px;flex-wrap:wrap}.hero,.controls,.product-detail{border:1px solid var(--line);border-radius:14px;background:var(--surface)}.hero{padding:clamp(24px,5vw,54px);margin-bottom:14px}.hero-kicker{font-size:.78rem;font-weight:800;letter-spacing:.12em;color:var(--accent)}.hero h1{font-size:clamp(2rem,5vw,4rem);line-height:1.05;max-width:820px;margin:.25em 0}.hero p{max-width:720px;color:var(--muted)}.controls{display:grid;grid-template-columns:2fr 1fr 1fr auto;gap:10px;padding:12px}.catalog-heading{display:flex;justify-content:space-between;align-items:end;gap:10px;margin:24px 0 10px}.catalog-heading h2{margin:0}.catalog-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.catalog-card{padding:0;border:1px solid var(--line);border-radius:14px;overflow:hidden;background:var(--surface);color:var(--ink);text-align:left;box-shadow:0 6px 24px rgba(15,23,42,.04)}.catalog-card:hover,.catalog-card:focus-visible{border-color:var(--accent);outline:3px solid var(--accent-soft)}.catalog-image,.catalog-placeholder{display:block;width:100%;aspect-ratio:4/5;background:var(--surface-2)}.catalog-image{object-fit:contain}.catalog-placeholder{display:grid;place-items:center;color:var(--muted)}.catalog-copy{display:grid;gap:4px;padding:12px}.catalog-copy strong{font-size:1rem;overflow-wrap:anywhere}.catalog-meta{display:flex;justify-content:space-between;gap:8px;color:var(--muted);font-size:.82rem}.product-detail{padding:18px;margin-top:24px;scroll-margin-top:12px}.detail-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.section{border-top:1px solid var(--line);margin-top:18px;padding-top:14px}.image-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.image-card{border:1px solid var(--line);border-radius:10px;overflow:hidden;background:var(--surface)}.image-card img{width:100%;aspect-ratio:1;object-fit:contain;background:var(--surface-2)}.image-card button{width:100%;border:0;border-top:1px solid var(--line);background:var(--surface);color:var(--accent)}.gate-grid,.evidence-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:8px}.gate-card,.evidence-card,.summary-grid div{padding:10px;background:var(--surface-2);border-radius:9px}.summary-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.summary-grid dd{margin:0;overflow-wrap:anywhere}.summary-grid dt,small{color:var(--muted)}.state,.gate-status,.asset-status{font-weight:800}.viewer{position:fixed;inset:0;background:#000e;display:grid;place-items:center;z-index:20}.viewer[hidden]{display:none}.viewer img{max-width:90vw;max-height:80vh}.viewer-controls{position:absolute;top:12px;right:12px;display:flex;gap:6px}.viewer-controls button{background:#fff;border:0;border-radius:8px;padding:0 12px}.skip{position:absolute;left:-9999px}.skip:focus{left:8px;top:8px;z-index:30}.empty{padding:18px;color:var(--muted)}footer{padding:24px 0;color:var(--muted)}@media(max-width:980px){.catalog-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:800px){.controls,.summary-grid,.image-grid,.gate-grid,.evidence-grid{grid-template-columns:1fr}.catalog-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:520px){.catalog-grid{grid-template-columns:1fr}.detail-head{display:block}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important}}
"""

"""Render post-bake evidence for the settled Sage Breeze Onepiece scene."""
...
JOB = ROOT / "config/products/siroino-sage-breeze-onepiece/job.json"
BLEND = (
    ROOT
    / "Assets/GenWorks/siroino-sage-breeze-onepiece/Source/Blender/SiroinoSageBreezeOnepiece.blend"
)
REPORT = (
    ROOT
    / "Assets/GenWorks/siroino-sage-breeze-onepiece/Evidence/Build/product-build-report.json"
)
EVIDENCE = (
    ROOT
    / "Assets/GenWorks/siroino-sage-breeze-onepiece/Evidence/Build/post-cloth-render.json"
)
...
def load_builder():
    # Rendering/pose helpers are canonicalized in the Verdant builder; this
    # script only supplies the Sage job and already-baked blend as inputs.
...
def main() -> int:
    ...
    multiview = (
        ROOT
        / "Assets/GenWorks/siroino-sage-breeze-onepiece/Previews/siroino-sage-breeze-onepiece-multiview.webp"
    )
    pose_review = (
        ROOT
        / "Assets/GenWorks/siroino-sage-breeze-onepiece/Previews/siroino-sage-breeze-onepiece-pose-review.webp"
    )
    ...
    evidence = {
        "schemaVersion": 1,
        "productId": "siroino-sage-breeze-onepiece",
        "status": "PASS",
        "frame": settled_frame,
        "renderedAfter": "Assets/GenWorks/siroino-sage-breeze-onepiece/Evidence/Build/cloth-simulation.json",
        "views": {
            name: {

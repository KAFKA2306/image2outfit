...
def main() -> int:
    ...
    made = [
        cube(f"{upper}_back", (0, 0.035, 0.82), (0.125, 0.018, 0.19), shell),
        cube(f"{upper}_front_L", (-0.064, -0.038, 0.82), (0.059, 0.018, 0.19), shell),
        cube(f"{upper}_front_R", (0.064, -0.038, 0.82), (0.059, 0.018, 0.19), shell),
        sleeve("sleeve_L", -1, shell),
        sleeve("sleeve_R", 1, shell),
        cube("inner_front", (0, -0.045, 0.68), (0.105, 0.012, 0.115), inner),
        cube(f"{bottom}_front", (0, -0.018, 0.49), (0.115, 0.026, 0.13), bottoms),
        cube(f"{bottom}_back", (0, 0.025, 0.49), (0.115, 0.026, 0.13), bottoms),

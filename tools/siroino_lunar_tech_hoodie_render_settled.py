...
BLEND = (
    ROOT
    / "Assets/GenWorks/siroino-lunar-tech-hoodie/Source/Blender/SiroinoLunarTechHoodie.blend"
)
REPORT = (
    ROOT
    / "Assets/GenWorks/siroino-lunar-tech-hoodie/Evidence/Build/product-build-report.json"
)
EVIDENCE = (
    ROOT
    / "Assets/GenWorks/siroino-lunar-tech-hoodie/Evidence/Build/post-cloth-render.json"
)
...
def load_builder():
    ...
    spec = importlib.util.spec_from_file_location(
        "siroino_lunar_tech_hoodie_build", path
    )
...
def main() -> int:
    ...
    multiview = (
        ROOT
        / "Assets/GenWorks/siroino-lunar-tech-hoodie/Previews/siroino-lunar-tech-hoodie-multiview.webp"
    )
    pose_review = (
        ROOT
        / "Assets/GenWorks/siroino-lunar-tech-hoodie/Previews/siroino-lunar-tech-hoodie-pose-review.webp"
    )

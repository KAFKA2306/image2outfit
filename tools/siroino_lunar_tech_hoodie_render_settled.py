"""Render post-bake evidence for the settled Lunar Tech Hoodie scene."""
...
JOB = ROOT / "config/products/siroino-lunar-tech-hoodie/job.json"
BLEND = ROOT / "Assets/GenWorks/siroino-lunar-tech-hoodie/Source/Blender/SiroinoLunarTechHoodie.blend"
REPORT = ROOT / "Assets/GenWorks/siroino-lunar-tech-hoodie/Evidence/Build/product-build-report.json"
EVIDENCE = ROOT / "Assets/GenWorks/siroino-lunar-tech-hoodie/Evidence/Build/post-cloth-render.json"
...
def load_builder():
    path = ROOT / "tools/siroino_lunar_tech_hoodie_build.py"
    spec = importlib.util.spec_from_file_location("siroino_lunar_tech_hoodie_build", path)
...
def main() -> int:
    ...
    multiview = ROOT / "Assets/GenWorks/siroino-lunar-tech-hoodie/Previews/siroino-lunar-tech-hoodie-multiview.webp"
    pose_review = ROOT / "Assets/GenWorks/siroino-lunar-tech-hoodie/Previews/siroino-lunar-tech-hoodie-pose-review.webp"
    import_base.contact_sheet(previews, multiview)
    builder.contact_sheet_named(pose_paths, pose_review, ("neutral", "arms-up", "arm-cross", "crouch", "sit", "prone"))
    ...
    evidence = {
        "schemaVersion": 1,
        "productId": "siroino-lunar-tech-hoodie",
        "status": "PASS",
        "frame": settled_frame,
        "renderedAfter": "Assets/GenWorks/siroino-lunar-tech-hoodie/Evidence/Build/cloth-simulation.json",

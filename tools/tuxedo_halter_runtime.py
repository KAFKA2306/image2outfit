...
def garment_geometry_sha256(objects: list[bpy.types.Object]) -> str:
    """Hash all mesh geometry independently of material assignments."""
    payload = {
        obj.name: mesh_geometry_sha256(obj)
...
def configure_cloth(
    ...
    *,
    ...
    if hasattr(cloth.point_cache, "use_disk_cache"):

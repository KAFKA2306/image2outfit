"""Render post-bake evidence for the settled Lily Vapor Yukata panels."""
...
BLEND = (
    ROOT / f"Assets/GenWorks/{PRODUCT_ID}/Source/Blender/SiroinoLilyVaporYukata.blend"
)
...
def load_builder():
    path = ROOT / "tools/siroino_lily_vapor_yukata_build.py"

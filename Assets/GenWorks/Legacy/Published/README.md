...
This directory contains historical image2outfit snapshots moved from the repository-root `Published/` directory so Unity can import and inspect them under `Assets/`.
